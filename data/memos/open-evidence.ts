...
const memo: Memo = {
  ...
  richContent: {
    thesis: {
      ...
      team:
        "CEO Daniel Nadler is a repeat founder. His prior company, Kensho, was an AI tool for financial services that sold to S&P. Daniel has intentionally built a technically rigorous, academically oriented execution culture — crucial for OpenEvidence credibility.",
      keyStats: [
    ...
    market: {
      ...
      tamTopDown: [
        {
          ...
          blocks: [
            { type: "text", text: "As OE deepens workflow penetration via OpenEvidence Visits (AI transcribed note taking feature) and Doctor Dialer (AI facilitated telemedicine product), it can expand $ spend per physician and take some of **~$20K/year** captured by EHRs." },
          ],
        },
        {
      ...
      competition: [
        ...
        {
          category: "AI documentation tools",

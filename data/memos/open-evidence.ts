...
const memo: Memo = {
  ...
  richContent: {
    thesis: {
      overview:
        "OpenEvidence is using PLG as a wedge in a regulated market: a free, high-trust, daily-use clinician Q&A product makes the enterprise motion a follow-on conversation, not a long sell. The ad-supported Q&A is the starting point; the goal is deeper workflow penetration — a Notion-like consumer-love to expansion dynamic, inside one of the hardest-to-disrupt industries in the world.",
      growthPath:
        "The growth path pairs the Q&A product (source of truth) with an AI scribe to become a high-fidelity system of record — capturing a meaningful share of the ~$10K/physician/year currently spent on EHR infrastructure.",
      whyNow:
        "Healthcare is hard to disrupt precisely because trust protected incumbents. OE's early traction (~1M consults/day as of March 2026) and Epic-embedded deployments at institutions like Mount Sinai suggest a credible break-out driven by bottoms-up distribution — the kind that doesn't need a CIO's signature to start.",
      keyStats: [
        { label: "Consults / day", value: "~1M" },
        { label: "US physician penetration", value: "~40%" },
        { label: "FTE on $50M+ ARR", value: "<50" },
        { label: "Entry valuation", value: "$12B" },
      ],
    },
    ...
    market: {
      ...
      tamTopDown:
        "As OE deepens workflow penetration via OpenEvidence Visits (notes) and Doctor Dialer (telemedicine), it will expand the $ per physician toward the ~$10K/year currently captured by EHR vendors. Net-new spend could eventually be unlocked if OE demonstrably reduces misdiagnoses and associated malpractice liability.",
      tamBottomUp:
        "There is clear interest from UK and European physicians, representing ~12M physicians globally — a 12x expansion on the current US addressable base. Adjacent user groups (nurses, PAs, medical students, pharmacists) add further scale; there are ~5M nurses in the US alone.",
      tailwinds: [
